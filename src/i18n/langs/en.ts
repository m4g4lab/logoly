export default {
    ...
    "A1STEP1": `Choose a style (e.g. Horizontal/Vertical, Pornhub/Youtube/...).`,
    "A1STEP2": `Edit the text in the center box.`,
    "A1STEP3": `Customize your logo (color, background, font size, etc.).`,
    "A1STEP4": `Finally, click the "Export" button and get the logo of your own.`,
    "Q2": `Can I use the generated logo for personal or commercial purposes?`,
